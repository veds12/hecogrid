...
class TeamSupportEnv(MultiGridEnv):
    ...
    def __init__(self, *args, reward=1, penalty=0.0, n_clutter=None, clutter_density=None, n_bonus_tiles=3, initial_reward=True, reward_decay=False, coordination_level=1, heterogeneity=1, **kwargs):
        ...
        self.AllActions = []
        AllActions = list(itertools.permutations(list(range(7)))) # It is important that the SAME order is used across episodes
...
# class TeamSupportEnv(MultiGridEnv_TeamSupportNheterogeneity):
#     mission = "collect as many treasures as possible"
#     metadata = {}
