...
class KeyForTreasure(MultiGridEnv):
    mission = "collect as many treasures as possible"
    metadata = {}

    def __init__(self, *args, reward=1, penalty=0.0, n_clutter=None, clutter_density=None, n_keys=30, n_bonus_tiles=3, initial_reward=True, reward_decay=False, coordination_level=1, heterogeneity=1, **kwargs):
